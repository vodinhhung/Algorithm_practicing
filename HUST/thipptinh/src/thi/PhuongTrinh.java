...
public class PhuongTrinh {
    ...
    public static double phanly(double[] coefficience, double a, double b){
        ...
        if(sokhoangcachnghiem == 0&&nghiem==0){
            ...
            PhuongTrinh.nghiem = nghiem;
            PhuongTrinh.sokhoangcachnghiem = sokhoangcachnghiem;
    ...
    public static boolean hoitu(double[] a, double b, double c){
        a[1] +=1;
        double ktra = 0.01;
        while(b>c){
            if(derivation(b, m)>=1){
